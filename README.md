...
3. Open [http://localhost:8080](http://localhost:3000) to view it in the browser.
...
Feel free to check the [issues page](https://github.com/topeogunleye/react-todo-app/issues).
